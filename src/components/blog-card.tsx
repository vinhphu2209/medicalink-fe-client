  ...
  return (
    <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 group cursor-pointer h-full flex flex-col">
      ...
      <div className="relative h-48 bg-gradient-to-b from-blue-50 to-white overflow-hidden">
        <Image
          src={thumbnailUrl || "/placeholder.svg?height=192&width=400&query=medical blog"}
          alt={title}
          width={400}
          height={192}
      ...
      <div className="p-6 space-y-4 flex-1 flex flex-col">
        {/* Category Badge */}
        <div>
          <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-200">{category.name}</Badge>
        </div>
